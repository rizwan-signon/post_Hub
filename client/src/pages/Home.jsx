    ...
    >
      <div className=" sm:max-w-6xl max-w-lg mx-auto flex sm:flex-row flex-col items-center sm:gap-8 sm:min-h-screen mt-[20%] sm:mt-0">
        <div className="w-1/2 p-2 flex flex-col sm:gap-5">
          <h1 className="sm:text-5xl font-bold bg-gradient-to-r from-blue-400 via-green-500 to-green-500 bg-clip-text text-transparent ">
            welcome to{" "}
            <h2 className="text-blue-700 uppercase inline">post Hub</h2>
